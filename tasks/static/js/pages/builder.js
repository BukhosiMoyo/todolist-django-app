...
var KTLayoutBuilder = function() {
			...
			$.ajax('/keen/index.php', {
				...
				var timer = setInterval(function() {
					$.ajax('/keen/index.php', {
						...
						$('<iframe/>').attr({
							src: '/keen/index.php?builder_export&builder_download&id=' + result.id + '&demo=' + demo,
			...
			$.ajax('/keen/index.php', {
				...
				var timer = setInterval(function() {
					$.ajax('/keen/index.php', {
						...
						$('<iframe/>').attr({
							src: '/keen/index.php?builder_export&builder_download&id=' + result.id,
							style: 'visibility:hidden;display:none',
						}).ready(function() {
	...
	var preview = function() {
		$('[name="builder_submit"]').click(function(e) {
			...
			$.ajax('/keen/index.php?demo=' + $(_self).data('demo'), {
				method: 'POST',
				data: $('[name]').serialize(),
			}).done(function(r) {
